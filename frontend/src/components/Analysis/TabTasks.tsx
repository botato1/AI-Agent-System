...
const tasks = [
  { title: '신규 광고 소재 3종 제작', assignee: '김나연', due: '5월 25일(토)', priority: 'high', status: '진행중', statusColor: 'bg-orange-100 text-orange-600' },
  { title: 'A/B 테스트 계획 수립', assignee: '이지원', due: '5월 26일(일)', priority: 'high', status: '진행중', statusColor: 'bg-orange-100 text-orange-600' },
  { title: '랜딩페이지 디자인 수정', assignee: '박민수', due: '5월 21일(화)', priority: 'mid', status: '완료', statusColor: 'bg-blue-100 text-blue-600' },
  { title: '성과 측정 지표 정의', assignee: '박민수', due: '5월 23일(목)', priority: 'low', status: '대기', statusColor: 'bg-gray-100 text-gray-500' },
]
